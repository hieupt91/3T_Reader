...
PUBLIC_INSTALLER_NAME = f"3TReader-{VERSION}-win-r6.exe"
PUBLIC_PORTABLE_NAME = f"3TReader-{VERSION}-win-portable-r6.zip"
RELEASE_NOTES = (
    ...
    "hơn, tự chuyển sang LibreOffice nếu máy không có Office/WPS; gỡ hoàn "
    ...
    "thành 1 file zip để gửi khi cần hỗ trợ; vá lỗi chữ ký cập nhật tự động "
    "không xác thực được (ảnh hưởng các bản 1.0.28-1.0.30, cần cài lại thủ "
    "công 1 lần bản 1.0.31 để vá vĩnh viễn); sửa icon file PDF hiển thị sai "
    "trong Windows Explorer chế độ xem chi tiết."
)
