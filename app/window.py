...
class PDFReaderApp(QMainWindow):
    ...
    def _build_toolbar_impl(self):
        ...
        self.g_ai.add(make_action_btn(_act_aiset, "AI Key"))
    ...
    def _apply_language_texts(self):
        ...
        _set_action("_act_ocr2", "action.ocr_all", "OCR toàn bộ")
        _set_action("_act_chat", "action.ai_chat", "Chat PDF")
        _set_action("_act_sum", "action.ai_summary", "Tóm tắt")
        _set_action("_act_trans", "action.ai_translate", "Dịch")
        _set_action("_act_srch", "action.ai_search", "Tìm nghĩa")
        _set_action("_act_key", "action.ai_key", "AI Key")
        _set_action("_act_usb", "action.check_usb", "Kiểm tra USB")
        _set_action("_act_sign", "action.sign", "Sign")
        _set_action("_act_settings", "action.sign_settings", "Cài đặt")
        _set_action("_act_pfx", "action.sign_pfx", "Ký PFX")
        _set_action("_act_batch", "action.sign_batch", "Ký lô")
        _set_action("_act_field", "action.signature_field", "Signature field")
        _set_action("_act_hand", "action.sign_hand", "Ký tay/dấu")
        _set_action("_act_verify", "action.verify_sign", "Verify")
        ...
        _set_action("act_ocr2", "action.ocr_all", "OCR toàn bộ")
        ...
        _set_action("act_sign_settings", "action.sign_settings", "Cài đặt")
