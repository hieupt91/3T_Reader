...
class PDFReaderApp(QMainWindow):
    ...
    def _build_menubar(self):
        ...
        act_ai_tts = menu_ai.addAction("🔊  Đọc văn bản trang này...")
        act_ai_tts.setShortcut(QKeySequence("Ctrl+Shift+R"))
        act_ai_tts.triggered.connect(lambda: open_tts_dialog(self))
